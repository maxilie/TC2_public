...
var ConsoleContentComponent = /** @class */ (function () {
    function ConsoleContentComponent(api) {
        this.api = api;
    }
    ConsoleContentComponent.prototype.ngOnInit = function () {
    };
    ConsoleContentComponent.prototype.getTasks = function () {
        this.lines$ = this.api.getTradingLogs();
    };
    ConsoleContentComponent.ctorParameters = function () { return [
    ...
    return ConsoleContentComponent;
}());
...
var LoginContentComponent = /** @class */ (function () {
    function LoginContentComponent(api, tabs) {
        this.api = api;
        this.tabs = tabs;
    }
    LoginContentComponent.prototype.ngOnInit = function () {
    };
    LoginContentComponent.prototype.login = function () {
        this.api.login();
        this.tabs.selectSubTab(_shared_service_tab_service__WEBPACK_IMPORTED_MODULE_3__["TabSubType"].console);
    };
    LoginContentComponent.prototype.getTradingLogs = function () {
        var logs = this.api.getTradingLogs();
        console.log(logs);
    };
    LoginContentComponent.ctorParameters = function () { return [
        { type: _shared_service_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
...
var MainContentComponent = /** @class */ (function () {
    function MainContentComponent(api, tabs) {
        this.api = api;
        this.tabs = tabs;
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getTradingLogs = function () {
    ...
    ApiService.prototype._getTradingLogs = function () {
    ...
    ApiService.prototype.ensureValidToken = function () {
        if (this.token == null
    ...
    ApiService.prototype.refreshToken = function () {
        var _this = this;
        this.http.post(this.API_URL + "/token/refresh", JSON.stringify({ token: this.token }), this.httpOptions).subscribe(function (data) {
            _this.updateData(data['access']);
        }, function (err) {
            _this.errors = err['error'];
        });
    };
    ApiDataEndpoint.logout = function () {
        this.token = null;
        this.token_expires = null;
    };
    ApiService.prototype.updateData = function (token) {
        this.token = token;
...
var TabService = /** @class */ (function () {
    ...
    TabService.prototype.selectSuperTab = function (tab) {
        this.selectedSuperTab = tab;
    };
    TabService.prototype.selectSubTab = function (tab) {
        this.selectedSubTab = tab;
    };
    TabService.prototype.getSelectedSuperTab = function () {
        return this.selectedSuperTab;
    };
    TabService.prototype.getSelectedSubTab = function () {
...
var TabareaSubComponent = /** @class */ (function () {
    function TabareaSubComponent(tabs) {
        this.tabs = tabs;
    ...
    TabareaSubComponent.prototype.ngOnInit = function () {
    };
    TabareaSubComponent.ctorParameters = function () { return [
...
var TabareaSuperComponent = /** @class */ (function () {
    function TabareaSuperComponent(tabs) {
        this.tabs = tabs;
        this.tabSuperType = _shared_service_tab_service__WEBPACK_IMPORTED_MODULE_2__["TabSuperType"];
    }
    TabareaSuperComponent.prototype.ngOnInit = function () {
    };
    TabareaSuperComponent.ctorParameters = function () { return [
        { type: _shared_service_tab_service__WEBPACK_IMPORTED_MODULE_2__["TabService"] }
    ]; };
