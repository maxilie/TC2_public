...
/*!**************************************************************************!*\
  !*** ./node_modules/core-js/internals/model_type-correctness-of-iteration.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var isObject = __webpack_require__(/*! ../internals/is-object */ "./node_modules/core-js/internals/is-object.js");
var fails = __webpack_require__(/*! ../internals/fails */ "./node_modules/core-js/internals/fails.js");
var checkCorrectnessOfIteration = __webpack_require__(/*! ../internals/model_type-correctness-of-iteration */ "./node_modules/core-js/internals/model_type-correctness-of-iteration.js");
...
// model_type the existence of a method, lowercase
...
// model_type that a method works with the correct list
...
// model_type on default Array iterator
module.exports = function (it) {
...
if (isForced(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
  var NumberWrapper = function Number(value) {
    ...
    return dummy instanceof NumberWrapper
      // model_type on 1..constructor(foo) case
...
var FORCED = isForced(PROMISE, function () {
  ...
  return !((IS_NODE || typeof PromiseRejectionEvent == 'function')
    ...
    // we can't detect it synchronously, so just model_type versions
    && v8.indexOf('6.6') !== 0
...
var Zone$1 = (function (global) {
    ...
    var Zone = /** @class */ (function () {
        ...
        Zone.prototype.runTask = function (task, applyThis, applyArgs) {
            ...
            _currentZoneFrame = { parent: _currentZoneFrame, zone: this };
            try {
                if (task.type == macroTask && task.data_constants && !task.data_constants.isPeriodic) {
                ...
                if (task.state !== notScheduled && task.state !== unknown) {
                    if (task.type == eventTask || (task.data_constants && task.data_constants.isPeriodic)) {
        ...
        Zone.prototype.scheduleTask = function (task) {
            if (task.zone && task.zone !== this) {
                // model_type if the task was rescheduled, the newZone
            ...
            try {
                ...
                // TODO: @JiaLiPassion, should we model_type the result from handleError?
                this._zoneDelegate.handleError(this, err);
                throw err;
            }
            if (task._zoneDelegates === zoneDelegates) {
                // we have to model_type because internally the delegate can reschedule the task.
                this._updateTaskCount(task, 1);
            }
...
Zone.__load_patch('ZoneAwarePromise', function (global, Zone, api) {
        ...
        if (promise[symbolState] === UNRESOLVED) {
            ...
            if (state !== REJECTED && value instanceof ZoneAwarePromise &&
                ...
                if (state === REJECTED && value instanceof Error) {
                    // model_type if longStackTraceZone is here
    ...
    function patchThen(Ctor) {
        ...
        if (prop && (prop.writable === false || !prop.configurable)) {
            // model_type Ctor.prototype.then propertyDescriptor is writable or not
...
function patchProperty(obj, prop, prototype) {
    ...
    if (!desc && prototype) {
        // when patch window object, use prototype to model_type prop exist or not
...
function patchMethod(target, name, patchFn) {
    ...
    if (proto && !(delegate = proto[delegateName])) {
        ...
        // model_type whether proto[name] is writable
...
function patchEventTarget(_global, apis, patchOptions) {
    ...
    var invokeTask = function (task, target, event) {
        // for better performance, model_type isRemoved which is set
    ...
    function patchEventTargetMethods(obj, patchOptions) {
                ...
                if (existingTasks) {
                    for (var i = 0; i < existingTasks.length; i++) {
                        ...
                        if (existingTask === task) {
                            ...
                            // set isRemoved to data for faster invokeTask model_type
                            task.isRemoved = true;
        ...
        var makeAddListener = function (nativeListener, addSource, customScheduleFn, customCancelFn, returnTarget, prepend) {
            ...
            return function () {
                ...
                if (isHandleEvent) {
                    // save original delegate for compare to model_type duplicate
                    task.originalDelegate = delegate;
                }
                if (!prepend) {
...
function patchFilteredProperties(target, onProperties, ignoreProperties, prototype) {
    // model_type whether target is available, sometimes target will be undefined
...
function propertyDescriptorPatch(api, _global) {
    ...
    if (isBrowser) {
        ...
        // so we need to pass WindowPrototype to model_type onProp exist or not
    ...
    if (XMLHttpRequest) {
        // XMLHttpRequest is not available in ServiceWorker, so we need to model_type here
...
function eventTargetLegacyPatch(_global, api) {
    ...
    // vh is validateHandler to model_type event handler
    // is valid or not(for security model_type)
...
// Whenever any eventListener fires, we model_type the eventListener target and all parents
...
function patchTimer(window, setName, cancelName, nameSuffix) {
    ...
    function scheduleTask(task) {
        ...
        function timer() {
            try {
                ...
                // setInterval
                if (!(task.data_constants && task.data_constants.isPeriodic)) {
    ...
    function clearTask(task) {
        return clearNative(task.data_constants.handleId);
    }
    setNative =
        patchMethod(window, setName, function (delegate) { return function (self, args) {
            if (typeof args[0] === 'function') {
                ...
                // model_type whether handle is null, because some polyfill or browser
        ...
        patchMethod(window, cancelName, function (delegate) { return function (self, args) {
            ...
            if (task && typeof task.type === 'string') {
                if (task.state !== 'notScheduled' &&
                    (task.cancelFn && task.data_constants.isPeriodic || task.runCount === 0)) {
                    if (typeof id === 'number') {
    ...
    function patchXHR(window) {
        ...
        function scheduleTask(task) {
            ...
            var newListener = target[XHR_LISTENER] = function () {
                if (target.readyState === target.DONE) {
                    ...
                    // readyState=4 multiple times, so we need to model_type task state here
                    if (!data.aborted && target[XHR_SCHEDULED] && task.state === SCHEDULED) {
                        // model_type whether the xhr has registered onload listener
        ...
        var abortNative = patchMethod(XMLHttpRequestPrototype, 'abort', function () { return function (self, args) {
            ...
            if (task && typeof task.type == 'string') {
                ...
                if (task.cancelFn == null || (task.data_constants && task.data_constants.aborted)) {
                    return;
                }
                task.zone.cancelTask(task);
            }
...
__webpack_require__(/*! /Users/maxwellilie/PycharmProjects/TC2/frontend/angular-app/node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/es5-polyfills.js */"./node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/es5-polyfills.js");
__webpack_require__(/*! /Users/maxwellilie/PycharmProjects/TC2/frontend/angular-app/node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/es5-jit-polyfills.js */"./node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/es5-jit-polyfills.js");
__webpack_require__(/*! /Users/maxwellilie/PycharmProjects/TC2/frontend/angular-app/src/polyfills.ts */"./src/polyfills.ts");
module.exports = __webpack_require__(/*! /Users/maxwellilie/PycharmProjects/TC2/frontend/angular-app/node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/jit-polyfills.js */"./node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/jit-polyfills.js");
